...
public class ProductController {
    ...
    public ResponseEntity<List<FieldError>> createProduct(@RequestBody @Valid ProductDTO productDTO,
        ...
        Product product = new Product(productDTO.getProductName(), productDTO.getPrice(), productDTO.getQuantity(),
                img, productDTO.getScreen(), productDTO.getHdh(), productDTO.getCameraT(), productDTO.getCpu(),
                productDTO.getRam(),
    ...
    public ResponseEntity<ProductDTO> detailProduct(@PathVariable int id) {
        ...
        ProductDTO productDTO = new ProductDTO(product.getIdProduct(), product.getProductName(), product.getPrice(),
                product.getQuantity(),
                product.getAvt(), product.getScreen(), product.getHdh(), product.getCameraT(), product.getCpu(),
                product.getRam(), product.getRom(),
                product.getSdCard(), product.getPin(), product.getProductType().getIdType(),
                product.getPromotion().getIdPromotion(),
                product.getNumOfStar(), product.getNumOfReview(), product.getStatus(),
